...
class OpenAIAdapter:
    ...
    def __init__(self, *, model: str, api_key: str | None = None, transport: JsonHttpTransport | None = None, base_url: str = "https://api.openai.com/v1", timeout: float = 60.0) -> None:
        if not model:
    ...
    def invoke(self, request: AdapterRequest) -> ProviderResponse:
        ...
        data = self.transport.post_json(
            ...
            payload={"model": self.model, "input": build_provider_prompt(request), "store": False},
