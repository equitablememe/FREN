...
Executable conformance, provenance, adversarial, and adapter-contract machinery is developed in a separate draft PR so implementation does not silently rewrite the foundation.
